...
function onCreate()
    ...
    makeLuaSprite('cornBag', 'backgrounds/farm/'..bagType, 1200, 550)
    addLuaSprite('cornBag')

    makeLuaSprite('sign', 'backgrounds/farm/sign', 0, 350)
    addLuaSprite('sign')

    for _, v in ipairs({'boyfriend', 'gf', 'dad', 'flatgrass', 'hills', 'farmhouse', 'grassLand', 'cornFence', 'cornFence2', 'bagType', 'cornBag', 'sign'}) do
